...
function MyBookings() {
    ...
    useEffect(() => {
        ...
        setMyBookings(Array.isArray(stored) ? stored : []);
    }, [])
  return (
    <div>
        <div>
        ...
        <div className={styles.searchDiv}>
            <Search isMyBookings searchText={searchText} setSearchText={setSearchText} myBookings={myBookings} setFilteredBookings={setFilteredBookings} />
        </div>
      ...
      <div className={styles.cardContainer}>
        <div className={styles.cardDiv}>
          ...
          <div className={styles.cardDetails}>
            ...
            <h6 className={styles.cityAndName}>{booking.city}, {booking.state}</h6>
            <p className={styles.hospitalType}>{booking.type}</p>
